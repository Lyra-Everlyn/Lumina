...
public class QuizFragment extends Fragment {
    ...
    private void setupHistoryRecyclerView() {
        ...
        // CẬP NHẬT: Gắn Listener để mở Review Mode khi click vào lịch sử Quiz
        historyAdapter = new QuizHistoryAdapter(historyList, session -> {
            ...
            intent.putExtra("REVIEW_SESSION_ID", session.getSessionId());
            intent.putExtra("QUIZ_TOPIC", session.getTopic());
            intent.putExtra("QUIZ_DIFFICULTY", session.getDifficulty());
